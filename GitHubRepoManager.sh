...
echo ""
echo "=========================================="
echo " GitHub Repository Manager v4.2.2"
echo "=========================================="
echo ""
...
echo "4) Bulk clone all user repositories (organized by user)"
echo "5) Fix git repository issues"
echo "6) Auto-commit & push multiple repositories"
echo "7) Set up repository branch protection"
echo "8) Manage pull requests (list, merge, close)"
echo "9) Cleanup repository for GA release (with backup)"
echo "10) Restore repository from backup"
echo "11) Manage repository secrets"
echo "12) Check GitHub API rate limits"
echo "13) Exit"
echo ""
